...
## 26-08-06
- [c] 移植C:\Users\admin\Desktop\XM\ELACO_StepMotor\Firmware\ELA_StepMotor项目的所有内容。已移植 ELA_LIB 全部 19 个业务模块到 module/drv+module/usr，FreeModbus 已剥离，Keil 工程已加入 module 组，GCC 语法检查 0 错误。待手动 Keil 编译+烧录。
