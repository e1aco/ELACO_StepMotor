...
Notes on Contents 
(1) Block Diagrams 
Some of the functional bl ocks, circuits, or constants in the block diagram may be omitted or simplified for explanatory 
purposes. 
...
combustion. 
In addition, do not use any devi ce that is applied the current with inserting in the wrong orientation or 
...
or IC fa ilure can cause smoke or ignition. (The over current can cause smoke or ignition from the IC itself.) In 
