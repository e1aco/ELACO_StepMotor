...
> ⚠ Multi-repo: When using GitNexus MCP tools (context/impact/query), always pass `repo: "ELA_StepMotor"`. There is another indexed repo `ELACO_StepMotorTMC5160` in the workspace.
